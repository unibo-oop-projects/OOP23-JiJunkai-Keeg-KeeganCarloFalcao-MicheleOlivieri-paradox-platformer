...
/**
 * Very useful interface to translate the view key handling to a common
 * {@code InputType} enum.
 * So the controller works unaware of view key type
 * 
 * <p>
 * NOTE: translate must adhere to InputType enum costants and not viceversa, so
 * make an utily method in
 * {@code InputType}
 * </p>
 * 
...
public interface InputTranslator<K> {
     ...
     *         case it happens it mostly due to {@code InputType}
