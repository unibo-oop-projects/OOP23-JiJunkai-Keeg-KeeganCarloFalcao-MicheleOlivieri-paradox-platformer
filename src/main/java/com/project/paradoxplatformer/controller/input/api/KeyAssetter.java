...
/**
 * KeyAsseter handles what is pressed during the gameplay and holds the logs to
 * a pool.
 * 
...
public interface KeyAssetter<K> {
     ...
     * 
     * @return {@code Set<Optional<InputType>>} an unmodifiable set because caller
     *         cannot modify it.
     *         So it is required to make this set immutable, (suggested:
     *         implementation needs to create a defensive copy).
     */
