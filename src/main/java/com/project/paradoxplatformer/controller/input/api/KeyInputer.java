 ...
 * <p>
 * NOTE: It is strongly suggested to bridge suche interface to Panels, aka
 * components containers,
 * which are able to listen key input
 * In such case, it has the responsabilty to capture any key events, which is
 * safer rather than a component
 * 
...
public interface KeyInputer<K> {
    ...
    /**
     * Getter of an immutable {@code KeyAssetter<K>}, which should be called on the
     * gameloop.
     * 
     ...
     * 
     * @param activateInput Very Useful for dedicated UI classes to activate the
     *                      keyboard input to current pane.
     */
