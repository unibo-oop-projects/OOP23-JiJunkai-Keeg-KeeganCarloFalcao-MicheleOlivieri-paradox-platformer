...
public abstract class AbstractTrasformableObject extends AbstractPositionableObject{
     ...
     * <p>
     * Upon trajectory trasformations it update its dimension and position vectors based on the object move-sets
     * define in the json config file. Such implementation is a default effect which all game objects (apart player) have
     * </p>
     * 
