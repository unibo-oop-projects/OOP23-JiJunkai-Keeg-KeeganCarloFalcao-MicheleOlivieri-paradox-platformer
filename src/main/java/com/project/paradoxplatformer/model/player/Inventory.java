 ...
 * <p> It provides basic actions such as add and remve an time, furthermore it has a special method to group the items based on their counting</p>
 */
public interface Inventory {
    ...
    /**
     * Provides the access to get the items collection (Note that they are unmodifiable).
     * @return the immutable items collections
     */
    Set<CollectableGameObject> getImmutableItems();

    /**
     * A special function to collect game objects and group them based on the object name and outputing their enumeration.
