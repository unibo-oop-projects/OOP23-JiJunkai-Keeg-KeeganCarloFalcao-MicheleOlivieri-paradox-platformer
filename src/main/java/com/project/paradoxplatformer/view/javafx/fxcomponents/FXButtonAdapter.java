...
public final class FXButtonAdapter extends AbstractFXGraphicAdapter implements Actionable {
     ...
     *                                  {@link Button}
     */
    public FXButtonAdapter(final Dimension dimension, final Coord2D relativePos, final String text) {
    ...
    /**
     * Constructs an FXButtonAdapter with default dimensions and position, and
     * specified text.
     * 
     * @param text the text to display on the button
     */
